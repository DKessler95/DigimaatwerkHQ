      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-foreground/70 mb-4">Digital transformation experts specializing in AI chatbots, workflow automation, and web development.</p>
          </div>
          
          <div>
            <h4 className="text-lg font-header font-medium mb-4">Services</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-foreground/70 hover:text-accent">AI Chatbots</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Workflow Automation</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Web Development</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">UI/UX Design</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Technical Consulting</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-header font-medium mb-4">Company</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-foreground/70 hover:text-accent">About Us</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Case Studies</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Testimonials</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Partners</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Careers</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-header font-medium mb-4">Legal</h4>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-accent">GDPR Compliance</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-accent">Site Credits</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-secondary pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-foreground/60 text-sm">
            &copy; {currentYear} Digimaatwerk. All rights reserved. Chamber of Commerce: KVK 12345678
          </div>
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-1">
              <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              <span className="text-xs text-foreground/60">Security Verified</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-xs text-foreground/60 ml-1">W3C Validated</span>
            </div>
            <div className="w-px h-4 bg-secondary"></div>
            <div className="flex items-center">
              ...
              <span className="text-xs text-foreground/60">Made in Netherlands</span>
            </div>
          </div>
        </div>
      </div>
